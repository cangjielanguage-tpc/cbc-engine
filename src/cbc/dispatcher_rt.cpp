...
NEWOBJ: {
    ...
    RTSupport::TypeInfo type = literals->at(args.xi12.imm12).uintptr;
    ...
    auto func = RTSupport::RuntimeInterface::AllocateObjectInstance();
...
VIRTUAL_CALL_2C: {
    ...
    return { Adapters::GenericI2CCallInstance(), target };
}
