...
protected:
    ...
    virtual void CAS(IReg dst, IReg obj, IReg src1, IReg src2, uint32_t fieldId) = 0;
    ...
    virtual void MemTailCopyTyped(MemSpace& ms, uint16_t ts, std::vector<uint32_t> refs) = 0;
