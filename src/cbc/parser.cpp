...
void Parser::InterpretOne(uint32_t opcode) {
    switch (opcode) {
        ...
        case B1piN::Fmt(B1piN::Size::SZ_8,  Sign::SIGNED): InterpretImmExt(Imm8::Decode(codeReader).imm,  8,  Sign::SIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_16, Sign::SIGNED): InterpretImmExt(Imm16::Decode(codeReader).imm, 16, Sign::SIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_32, Sign::SIGNED): InterpretImmExt(Imm32::Decode(codeReader).imm, 32, Sign::SIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_48, Sign::SIGNED): InterpretImmExt(Imm48::Decode(codeReader).imm, 48, Sign::SIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_8,  Sign::UNSIGNED): InterpretImmExt(Imm8::Decode(codeReader).imm,  8,  Sign::UNSIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_16, Sign::UNSIGNED): InterpretImmExt(Imm16::Decode(codeReader).imm, 16, Sign::UNSIGNED); break;
        case B1piN::Fmt(B1piN::Size::SZ_32, Sign::UNSIGNED): InterpretImmExt(Imm32::Decode(codeReader).imm, 32, Sign::UNSIGNED); break;

        case ConditionalBranch::B2rrd8::Fmt(CC::EQ,  Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::EQ,  Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::EQ,  Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::EQ,  Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::NE,  Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::NE,  Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::NE,  Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::NE,  Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::LT,  Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::LT,  Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::LT,  Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::LT,  Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::GE,  Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::GE,  Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::GE,  Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::GE,  Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::ULT, Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::ULT, Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::ULT, Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::ULT, Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::UGE, Width::W32): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::UGE, Width::W32); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::UGE, Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::UGE, Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::REQ, Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::REQ, Width::W64); break;
        case ConditionalBranch::B2rrd8::Fmt(CC::RNE, Width::W64): B2rrd8BranchIf(ConditionalBranch::B2rrd8::Decode(codeReader), CC::RNE, Width::W64); break;

        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T8, 0):  B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T8, 0);
        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T8, 1):  B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T8, 1);
        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T16, 0): B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T16, 0);
        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T16, 1): B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T16, 1);
        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T0, 0):  B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T0, 0);
        case ConditionalBranch::B3xrrdT::BranchIf(ConditionalBranch::B3xrrdT::T::T0, 1):  B3xrrdTBranchIf(ConditionalBranch::B3xrrdT::Decode(codeReader), ConditionalBranch::B3xrrdT::T::T0, 1);
        ...
        case ConditionalBranch::B2xri16dM::BranchIf(ConditionalBranch::B2xri16dM::M::M0, 0): B2xri16d0BranchIf(ConditionalBranch::B2xri16dM::Decode(codeReader), 0);
        case ConditionalBranch::B2xri16dM::BranchIf(ConditionalBranch::B2xri16dM::M::M0, 1): B2xri16d0BranchIf(ConditionalBranch::B2xri16dM::Decode(codeReader), 1);
        case ConditionalBranch::B2xri16dM::BranchIf(ConditionalBranch::B2xri16dM::M::M16, 0): B2xri16d16BranchIf(ConditionalBranch::B2xri16dM::Decode(codeReader), 0);
        case ConditionalBranch::B2xri16dM::BranchIf(ConditionalBranch::B2xri16dM::M::M16, 1): B2xri16d16BranchIf(ConditionalBranch::B2xri16dM::Decode(codeReader), 1);
...
void Parser::InterpretImmExt(uint64_t imm, uint32_t bits, Sign sign) {
    immDecoder.SetImmExt(imm, bits, sign);
}
...
void Parser::B2xri8d8BranchIf(ConditionalBranch::B2xri8d8 args, uint32_t page) {
    ...
    auto immVal = cc.IsSigned() ? MathUtils::SignExtend(static_cast<uint32_t>(args.imm), 8) : MathUtils::ZeroExtend(static_cast<uint32_t>(args.imm), 8);
