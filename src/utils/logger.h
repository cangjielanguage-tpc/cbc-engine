...
#define LOG(level, log, ...) (log).Log(level, [&](::Stream::Output& out) { out.PrintLn(__VA_ARGS__); })
...
#define LOG_DEBUG(...) LOG(::Logging::DEBUG, __VA_ARGS__)
#define LOG_INFO(...) LOG(::Logging::INFO, __VA_ARGS__)
#define LOG_WARN(...) LOG(::Logging::WARN, __VA_ARGS__)
#define LOG_ERROR(...) LOG(::Logging::ERROR, __VA_ARGS__)
#define LOG_FATAL(...) LOG(::Logging::FATAL, __VA_ARGS__)

#define LOGS_TRACE(...) LOGS(::Logging::TRACE, __VA_ARGS__)
#define LOGS_DEBUG(...) LOGS(::Logging::DEBUG, __VA_ARGS__)
#define LOGS_INFO(...) LOGS(::Logging::INFO, __VA_ARGS__)
#define LOGS_WARN(...) LOGS(::Logging::WARN, __VA_ARGS__)
#define LOGS_ERROR(...) LOGS(::Logging::ERROR, __VA_ARGS__)
#define LOGS_FATAL(...) LOGS(::Logging::FATAL, __VA_ARGS__)
